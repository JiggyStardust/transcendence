...
export default function Input({id, label, type = "text", value, tooltip, focusTooltip, onChange, onFocus, onBlur,}: InputProps) {
	...
	return (
		<div className="flex flex-col m-2 px-4  text-black dark:text-white">
			...
			<input className="p-1 border border-white rounded-sm"
				type={type} id={id} value={value} onChange={onChange} onFocus={onFocus} onBlur={onBlur}/>
